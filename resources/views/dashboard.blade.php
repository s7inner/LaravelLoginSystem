...
<div
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8 text-center">
        ...
        <p class="mt-2">Data from the Users table:</p>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{{ route('user.delete', ['id' => $user->id]) }}" style="display: inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger btn-sm" style="background-color: #dc3545; border-color: #dc3545; color: #fff;" onmouseover="this.style.backgroundColor='#bd2130'; this.style.borderColor='#bd2130';" onmouseout="this.style.backgroundColor='#dc3545'; this.style.borderColor='#dc3545';">Delete</button>
                            </form>
